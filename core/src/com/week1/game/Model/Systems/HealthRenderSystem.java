...
public class HealthRenderSystem implements ISystem {
    ...
    public void addNode(int id, PositionComponent positionComponent, HealthComponent healthComponent, OwnedComponent ownedComponent) {
        nodes.put(id, new HealthRenderNode(positionComponent, healthComponent, ownedComponent));
    }
